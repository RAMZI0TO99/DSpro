...
classDiagram
    ...
    FastAPIApp --> GeminiAPI : query optimization\n& chat
...
sequenceDiagram
    ...
    API->>Gemini: optimize_query_with_llm(raw_query)
    Gemini-->>API: optimized English keywords
